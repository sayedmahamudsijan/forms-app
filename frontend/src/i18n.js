  ...
  en: {
    translation: {
      ...
      profile: {
        ...
        passwordPlaceholder: 'Enter your password (optional)',
        ...
        salesforce_integration_title: 'Sync with Salesforce',
        salesforce_sync_button: 'Sync Profile to Salesforce',
        ...
        odoo_token_generated: 'API token generated successfully',
        odoo_token_failed: 'Failed to generate API token',
        support_ticket_title: 'Create Support Ticket',
        support_ticket_button: 'Create Support Ticket',
        summary: 'Summary',
        summaryPlaceholder: 'Enter ticket summary',
        summaryRequired: 'Summary is required',
        priority: 'Priority',
        priorityLow: 'Low',
        priorityAverage: 'Average',
        priorityHigh: 'High',
        support_ticket_success: 'Support ticket created successfully',
        support_ticket_failed: 'Failed to create support ticket',
        submit: 'Submit',
      },
      search: {
      ...
      createTemplate: {
        ...
        questionDescriptionPlaceholder: 'Enter template description',
  ...
  es: {
    translation: {
      ...
      profile: {
        ...
        passwordPlaceholder: 'Ingresa tu contraseña (opcional)',
        ...
        answers: 'Respuestas',
        answer: '{question}: {value}',
        salesforce_integration_title: 'Sincronizar con Salesforce',
        salesforce_sync_button: 'Sincronizar Perfil con Salesforce',
        ...
        odoo_token_generated: 'Token de API generado exitosamente',
        odoo_token_failed: 'Error al generar el token de API',
        support_ticket_title: 'Crear Ticket de Soporte',
        support_ticket_button: 'Crear Ticket de Soporte',
        summary: 'Resumen',
        summaryPlaceholder: 'Ingresa el resumen del ticket',
        summaryRequired: 'El resumen es obligatorio',
        priority: 'Prioridad',
        priorityLow: 'Baja',
        priorityAverage: 'Media',
        priorityHigh: 'Alta',
        support_ticket_success: 'Ticket de soporte creado exitosamente',
        support_ticket_failed: 'Error al crear el ticket de soporte',
        submit: 'Enviar',
      },
      search: {
      ...
      createTemplate: {
        ...
        questionDescriptionPlaceholder: 'Ingresa la descripción de la plantilla',
    ...
    i18n
      ...
      .then(() => {
        console.log('✅ i18next initialized successfully', {
          ...
          createTemplateKeys: Object.keys(resources.en.translation.createTemplate),
          profileKeys: Object.keys(resources.en.translation.profile), // Added for debugging
        });
        resolve();
      })
      .catch((error) => {
